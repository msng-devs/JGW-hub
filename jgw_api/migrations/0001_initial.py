    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_email', models.CharField(db_column='MEMBER_EMAIL', max_length=256, unique=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='POST_POST_ID_PK', on_delete=django.db.models.deletion.DO_NOTHING, to='jgw_api.post'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
