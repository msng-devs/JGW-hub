...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Tag',
            fields=[
                ('tag_id_pk', models.AutoField(db_column='TAG_ID_PK', primary_key=True, serialize=False)),
                ('tag_name', models.CharField(db_column='TAG_NAME', max_length=20, unique=True)),
            ],
            options={
                'db_table': 'TAG',
                'managed': True,
        ...
        migrations.CreateModel(
            name='Attendance',
            fields=[
                ('attendance_pk', models.BigAutoField(db_column='ATTENDANCE_PK', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='PostHasTag',
            fields=[
                ('post_post_id_pk', models.OneToOneField(db_column='POST_POST_ID_PK', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='jgw_api.post')),
                ('tag_tag_id_pk', models.ForeignKey(db_column='TAG_TAG_ID_PK', on_delete=django.db.models.deletion.DO_NOTHING, to='jgw_api.tag')),
            ],
            options={
