...
class ApiRoute(models.Model):
    ...
    method_method_pk = models.IntegerField(db_column='METHOD_METHOD_PK')  # Field name made lowercase.
    role_role_pk = models.IntegerField(db_column='ROLE_ROLE_PK', blank=True, null=True)  # Field name made lowercase.
    service_service_pk = models.IntegerField(db_column='SERVICE_SERVICE_PK')  # Field name made lowercase.
...
class Attendance(models.Model):
    attendance_pk = models.AutoField(db_column='ATTENDANCE_PK', primary_key=True)  # Field name made lowercase.
