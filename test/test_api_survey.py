# TODO: 설문조사 기능은 기존 django 코드를 바탕으로 추후 재구성될 예정입니다.

# from rest_framework.test import APITestCase
# from rest_framework import status
# from rest_framework.response import Response
# from backups.models import Role, Member, Rank, Major, Config
#
...
#             config_nm="admin_role_pk", config_val="500", config_pk=500
#         )
#
...
#         cls.collection_survey = __create_collection(
#             db, constant.SURVEY_POST_DB_NME, None
#         )
...
#                 {
#                     "type": 0,
#                     "title": get_random_string(length=random.randint(5, 20)),
#                     "description": get_random_string(length=random.randint(5, 20)),
#                     "require": 1,
#                 },
#                 {
#                     "type": 0,
...
#                         "answers": [
#                             {
#                                 "parent_quiz": quizzes[0]["_id"],
#                                 "text": get_random_string(
#                                     length=random.randint(10, 100)
#                                 ),
#                             },
#                             {
#                                 "parent_quiz": quizzes[1]["_id"],
#                                 "text": get_random_string(
#                                     length=random.randint(10, 100)
#                                 ),
#                             },
#                             {
#                                 "parent_quiz": quizzes[2]["_id"],
#                                 "selection": random.choice([0, 2, 3]),
#                             },
#                             {
#                                 "parent_quiz": quizzes[3]["_id"],
#                                 "selections": list(
#                                     list(
#                                         itertools.combinations(
#                                             [0, 1, 2, 3], random.randint(1, 4)
#                                         )
#                                     )[0]
#                                 ),
#                             },
...
#             **self.__get_header(member_instance),
#         )
...
#         # when
#         respons: Response = self.client.post(
#             self.url + f"{self.survey_pks[0]}/answer/",
#             data=insert_data,
#             content_type="application/json",
#             **self.__get_header(member_instance),
#         )
...
#             self.url + "?page=0", **self.__get_header(member_instance)
#         )
#         # print(respons.content)
#
#         # then
...
#         # when
#         respons: Response = self.client.get(
#             self.url + f"{self.survey_pks[0]}/", **self.__get_header(member_instance)
#         )
#         # print(respons.content)
#
#         # then
...
#         # when
#         respons: Response = self.client.get(
#             self.url + f"{self.survey_pks[1]}/answer/",
#             **self.__get_header(member_instance),
#         )
#         # print(respons.content)
#
...
#             self.url + f"{self.survey_pks[2]}/", **self.__get_header(member_instance)
#         )
#         # print(respons.content)
#
#         # then
...
#             role_role_pk=Role.objects.get(role_nm="ROLE_DEV")
#         )
#         data = {"title": "변경", "activate": 0}
#
#         # when
#         respons: Response = self.client.patch(
#             self.url + f"{self.survey_pks[45]}/",
#             data=data,
#             **self.__get_header(member_instance),
#         )
#         # print(respons.content)
...
#         )
#         answer = list(
#             self.collection_quiz.find({"parent_post": ObjectId(self.survey_pks[1])})
#         )[0]
#
#         # when
#         respons: Response = self.client.get(
#             self.url
#             + f'{self.survey_pks[1]}/answer/?analyze=1&answer_id={answer["_id"]}',
#             **self.__get_header(member_instance),
#         )
#         # print(respons.content)
#
