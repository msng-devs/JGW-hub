...
# 로직 내부에서 발생하는 Exception은 hub.log에 기록되며, 로직 내부 Excepiton 발생 시,
# 미들웨어 레이어에서 발생한 에러 trace가 hub_errors.log에 기록됩니다.
# --------------------------------------------------------------------------
...
class RouterLoggingMiddleware(BaseHTTPMiddleware):
    ...
    async def _log_response(
        ...
        overall_status = "successful" if response is not None and response.status_code < 400 else "failed"
