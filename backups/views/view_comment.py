...
from backups.custom_pagination import CommentPageNumberPagination
...
class CommentViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        request_data = {
            ...
            "comment_delete": request.data["comment_delete"],
            "post_post_id_pk": request.data["post_post_id_pk"],
        ...
        if (
            ...
            or user_role_id >= board_instance.role_role_pk_comment_write_level.role_pk
        ):
            ...
            update_log = (
                f"{user_uid} Comment data created"
    ...
    def partial_update(self, request, *args, **kwargs):
        ...
        if (
            user_role_id >= board_instance.role_role_pk_comment_write_level.role_pk
            ...
            responses_data = serializer.data
            update_log = (
                f"{user_uid} Comment data patched"
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        if (
            ...
            logger.debug(
                f"{user_uid} Comment data deleted\tkey: {key}\ttitle: {name[:25]}"
            )
