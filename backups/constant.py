...
SURVEY_POST_DB_VALIDATOR = {
    "$jsonSchema": {
        ...
        "bsonType": "object",
        "required": ["title", "description", "writer", "role", "quizzes", "answers"],
        "properties": {
            ...
            "role": {"bsonType": "int"},
            "quizzes": {"bsonType": "array", "items": {"bsonType": "object"}},
            "answers": {"bsonType": "array", "items": {"bsonType": "object"}},
        },
    }
}
...
SURVEY_TEXT_QUIZ_VALIDATOR = {
    "$jsonSchema": {
        ...
        "bsonType": "object",
        "required": ["title", "description", "require", "answers"],
        "properties": {
            "title": {"bsonType": "string", "maxLength": 32},
            "description": {"bsonType": "string", "maxLength": 256},
            "require": {
...
SURVEY_TEXT_ANSWER_VALIDATOR = {
    "$jsonSchema": {
        ...
        "properties": {
            "user": {"bsonType": "string", "maxLength": 32},
            "text": {"bsonType": "string", "maxLength": 256},
        },
    }
}
        ...
        "properties": {
            ...
            "options": {
                ...
                "items": {
                    "bsonType": "object",
                    "required": ["text"],
                    "properties": {"text": {"bsonType": "string", "maxLength": 16}},
                },
            },
            "answers": {"bsonType": "array", "items": {"bsonType": "object"}},
        },
